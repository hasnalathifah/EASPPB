...
@Composable
fun IsiForm(navController: NavController) {
    Column(
...
//        )
        Text(text = "Isi form untuk mendaftar menjadi mitra", fontSize = 20.sp, fontWeight = FontWeight.Bold)

        Spacer(modifier = Modifier.height(20.dp))
        Button(onClick = { isiFormHandler(navController) },
...
fun isiFormHandler(navController: NavController){
