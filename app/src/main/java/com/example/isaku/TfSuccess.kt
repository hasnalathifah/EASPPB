...
@Composable
fun TfSuccess(navController: NavController) {
    Column(
    ...
    Column(
        ...
        Text(text = "Transaksi Berhasil!", fontSize = 20.sp, fontWeight = FontWeight.Bold)

        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { tfSuccessHandler(navController) },
...
fun tfSuccessHandler(navController: NavController){
