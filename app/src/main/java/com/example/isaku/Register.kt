...
//        )
        ...
        Text(text = "Daftar Akun Mitra i.saku", fontSize = 28.sp, fontWeight = FontWeight.Bold)

//        Spacer(modifier = Modifier.height(4.dp))
//        Text(text = "Masuk ke akun mobile banking BSI")

        Spacer(modifier = Modifier.height(10.dp))
        OutlinedTextField(value = nama, modifier = Modifier.fillMaxWidth(), onValueChange = { nama = it }, label = {
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { regisHandler(navController, noTelp, password) },
...
fun regisHandler(navController: NavController, noTelp: String, password: String){
